...
tempoAtual;
let segundos = Math.floor(tempoFinal / 1000); let minutos = Math.floor(segundos / 60);
...
function atualizaCronometro(){
    for (let i=o; i<contadores.length;++){   

document.getElemntById("das"-textContent =
...
setlterval(atualizaCronometro, 1000);
}
cacula Tempo/tempos